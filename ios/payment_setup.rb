...
OptionParser.new do |options|
    options.banner = "Setup the payment to an Xcode target."
    ...
    options.on("-s", "--urlScheme=URLSCHEME", String, "url scheme for AliPay") do |opts|
...
project.targets.each do |target|
    if target.name == "Runner"
        ...
        sectionObject.build_configurations.each do |config|
            ...
            # Check if the app_id or url_scheme already exists in the plist
